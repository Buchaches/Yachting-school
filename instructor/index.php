                        ...
                        <div class="statistics__group">
                            <div class="statistics__item client first element-animation">
                                <div class="item__text">
                                    ...
                                    <div class="item__count">
                                        <?=$trip=countRowsBookingInstructor($instructor_id, 1)?>
                                    </div>
                                </div>
                            </div>
                            <div class="statistics__item client second element-animation">
                                ...
                                <div class="item__text">
                                    ...
                                    <div class="item__count">
                                        <?=$training=countRowsBookingInstructor($instructor_id, 2)?>
                                    </div>
                                </div>
                            </div>
                            <div class="statistics__item client third element-animation">
                                <div class="item__text">
                                    ...
                                    <div class="item__count">
                                        <?=$race=countRowsBookingInstructor($instructor_id, 3)?>
                                    </div>                                   
                                </div>
                            </div>
                        </div>
                        ...
                        <table class="main__table">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    WHERE bookings.instructor_id = '$instructor_id' AND timeslots.date >= '$date'
