<div class="sidebar" id="sidebar">
    ...
    <div class="sidebar__menu">
        <ul>
            <li>
                <a class="menu__link" href="<?php echo BASE_URL . 'instructor/index.php'?>">
            ...
            <li>
                <a class="menu__link" href="<?php echo BASE_URL . 'instructor/bookings.php'?>">
                    <div class="menu__link__item">
            ...
            <li>
                <a class="menu__link" href="<?php echo BASE_URL . 'instructor/settings.php'?>">
                    <div class="menu__link__item">
