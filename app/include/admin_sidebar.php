<div class="sidebar">
    ...
    <div class="sidebar__menu">
        <ul>
            <li>
                <a class="menu__link" href="<?php echo BASE_URL . 'admin/index'?>">
            ...
            <li>
                <a class="menu__link" href="<?php echo BASE_URL . 'admin/bookings'?>">
                    <div class="menu__link__item">
            ...
            <li>
                <a class="menu__link" href="<?php echo BASE_URL . 'admin/timeslots'?>">
                    <div class="menu__link__item">
            ...
            <li>
                <a class="menu__link" href="<?php echo BASE_URL . 'admin/clients'?>">
                    <div class="menu__link__item">
            ...
            <li>
                <a class="menu__link" href="<?php echo BASE_URL . 'admin/instructors'?>">
                    <div class="menu__link__item">
            ...
            <li>
                <a class="menu__link" href="<?php echo BASE_URL . 'logout'?>">
                    <div class="menu__link__item">
